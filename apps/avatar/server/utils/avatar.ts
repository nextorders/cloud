...
// Extend openPeeps.Options
type Head = BaseOptions['head']
type Face = BaseOptions['face']
type FacialHair = BaseOptions['facialHair']
type Accessories = BaseOptions['accessories']

export interface Options extends StyleOptions<BaseOptions> {
  seed?: string
  flip?: boolean
  rotate?: number
  scale?: number
